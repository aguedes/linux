...
static void hci_le_conn_complete_evt(struct hci_dev *hdev, struct sk_buff *skb)
{
	...
	case LE_CONN_ROLE_MASTER:
		...
		if (!conn || conn->dst_type != ev->bdaddr_type) {
			/*
			 * If there is no hci_conn object with address and
			 * address type equal to the event, it means this
			 * new connection was trigger through HCI socket
